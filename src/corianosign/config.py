...
class AppConfig:
    ...
    # l'utente ha scelto "Non chiederlo più" per l'app predefinita dei .p7m
    dont_ask_default_p7m: bool = False
...
def load_config() -> AppConfig:
    ...
    cfg = AppConfig(
        ...
        dont_ask_default_p7m=bool(data.get("dont_ask_default_p7m", False)),
